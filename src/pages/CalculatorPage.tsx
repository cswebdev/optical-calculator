...
import GlassesCalculator from '../components/calculators/GlassesCalculator';
import CalculatorSelector from '../components/calculators/CalculatorSelector';
import ContactCalculator from '../components/calculators/ContactCalculator';
import TopNav from '../components/navigation/TopNav';
import jsPDF from 'jspdf';
import html2canvas from 'html2canvas';
import PrintableQuoteSheet from '../components/calculators/PrintableQuoteSheet';

const CalculatorPage: React.FC = () => {
  const [selectedLocation, setSelectedLocation] = useState('');
  const [selectedCalculator, setSelectedCalculator] = useState<"glasses" | "contacts">("glasses");
    ...
    <div className="relative flex flex-col min-h-screen items-left">
      ...
      <div className="flex justify-start">
        <CalculatorSelector
          ...
          onChange={(type) => setSelectedCalculator(type as "glasses" | "contacts")}
        />
      </div>
